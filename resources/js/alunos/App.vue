...
<script>
import SidebarAluno from "../../Templates/sidebar/sidebarAluno.vue";
export default {
    components: { SidebarAluno },
    data() {
        return {
            aluno: {
                name: "Nakaoshi",
